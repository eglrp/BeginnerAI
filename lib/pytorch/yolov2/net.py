...
import numpy as np
import lib.pytorch.yolov2.loss as yolo_loss
...
class Darknet(nn.Module):
    def __init__(self, cfgfile):
        ...
        self.blocks = yolo_utils.ConfigUtils.parse_cfg(cfgfile)
    ...
    def print_network(self):
        yolo_utils.ConfigUtils.print_cfg(self.blocks)
