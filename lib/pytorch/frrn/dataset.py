...
class VOCSegDataSet(torch.utils.data.Dataset):
    def __init__(self, root='/input/VOC', phase="train",
                 is_transform=False,
        ...
        self.root = root
        self.infoFile = os.path.join(self.root, "MainSet", "seg_%s.txt" % phase)

        lines = tuple(open(self.infoFile, 'r'))
        self.file_list = [id.rstrip() for id in lines]
